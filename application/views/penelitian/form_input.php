		...
		<div class='col-xs-12'>
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">Tambah Penelitian</h3>
				</div>
				<div class="box-body">
					<?php
					echo form_open('penelitian/post', array('role' => "form", 'id' => "myForm", 'data-toggle' => "validator"));
					?>
					<div class="form-group">
						<label for="judul" class="control-label">Judul Penelitian <span style="color:red"> *</span></label>
						<div class="input-group">
							<input type="text" class="form-control" name="judul" id="judul" data-error="Judul harus diisi" placeholder="Judul" value="" required />
                    ...
                    <div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="bidang_ilmu" id="bidang_ilmu" data-error="Bidang Ilmu harus diisi" placeholder="Bidang Ilmu" value="" required />
							<span class="input-group-addon">
								<span class="fa fa-cube"></span>
							</span>
						</div>
                    ...
                    <div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="lembaga" id="lembaga" data-error="Lembaga harus diisi" placeholder="Lembaga" value="" required />
							<span class="input-group-addon">
								<span class="fa fa-cube"></span>
							</span>
						</div>
