						...
						<div class="input-group">
							<select class="form-control" name="program_studi" data-error="Program studi harus diisi" required>
                               ...
                               <?php foreach ($fakultas as $a) { ?>
                                <option value="<?= $a->nama_fakul ?>" <?php if($record['program_studi'] == $a->nama_fakul){echo 'selected';} ?>><?= $a->nama_fakul ?></option>
                               <?php } ?>
                            </select>
							<span class="input-group-addon">
                    ...
                    <div class="form-group">
						...
						<div class="input-group">
							<select class="form-control" name="jk" required data-error="Jenis Kelamin harus diisi">
                                <option value="">- PILIH -</option>
                                <option value="Laki-laki" <?php if($record['jk'] == 'Laki-laki'){echo 'selected';} ?> >Laki-laki</option>
                                <option value="Perempuan" <?php if($record['jk'] == 'Perempuan'){echo 'selected';} ?>>Perempuan</option>
                            </select>
							<span class="input-group-addon">
								<span class="fa fa-list"></span>
							</span>
                	...
                	<div class="form-group">
						...
						<div class="input-group">
							<select class="form-control" name="pendidikan_tertinggi" data-error="Pendidikan tertinggi harus diisi" required>
								<option value=''>- PILIH -</option>;
								<option value='D1' <?php if($record['pendidikan_tertinggi'] == 'D1'){echo 'selected';} ?>>D1</option>;
								<option value='D2' <?php if($record['pendidikan_tertinggi'] == 'D2'){echo 'selected';} ?>>D2</option>;
								<option value='D3'<?php if($record['pendidikan_tertinggi'] == 'D3'){echo 'selected';} ?>>D3</option>;
								<option value='D4' <?php if($record['pendidikan_tertinggi'] == 'D4'){echo 'selected';} ?>>D4</option>;
								<option value='S1' <?php if($record['pendidikan_tertinggi'] == 'S1'){echo 'selected';} ?>>S1</option>;
								<option value='S2' <?php if($record['pendidikan_tertinggi'] == 'S2'){echo 'selected';} ?>>S2</option>;
								<option value='S3' <?php if($record['pendidikan_tertinggi'] == 'S3'){echo 'selected';} ?>>S3</option>;
							</select>
							<span class="input-group-addon">
								<span class="fa fa-list"></span>
							</span>
                    ...
                    <div class="form-group">
						...
						<div class="input-group">
							<select class="form-control" name="status_ikatan_kerja" data-error="Status ikatan kerja harus diisi" required> 
                                <option value="">- PILIH -</option>
                                <option value="Dosen Tetap" <?php if($record['status_ikatan_kerja'] == 'Dosen Tetap'){echo 'selected';} ?>>Dosen Tetap</option>
                                <option value="Dosen Tidak Tetap" <?php if($record['status_ikatan_kerja'] == 'Dosen Tidak Tetap'){echo 'selected';} ?>>Dosen Tidak Tetap</option>
                            </select>
							<span class="input-group-addon">
								<span class="fa fa-list"></span>
							</span>
                    ...
                    <div class="form-group">
						...
						<div class="input-group">
							<select class="form-control" name="status_aktivitas" required data-error="Status aktivitas harus diisi">
                                <option value="">- PILIH -</option>
                                <option value="Aktif" <?php if($record['status_aktivitas'] == 'Aktif'){echo 'selected';} ?>>Aktif</option>
                                <option value="Tidak Aktif" <?php if($record['status_aktivitas'] == 'Tidak Aktif'){echo 'selected';} ?>>Tidak Aktif</option>
                            </select>
							<span class="input-group-addon">
								<span class="fa fa-list"></span>
							</span>
