        ...
        <div class="wizard">
            ...
            <form name="formPendaftaran" role="form" method="POST">
                <div class="tab-content">
                    ...
                    <h3 class="bg-primary text-center h3">Data Diri</h3>
                        <div class="step2">
                        <div class="row">
                              <div class="col-md-12">
                        ...
                        <div class="row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="row">
                                    <div class="col-md-4">
                                      <select name="visa_status" id="tgl_lahir" class="dropselectsec1">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Nama belakang">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="Nama belakang">
                                    </div>
