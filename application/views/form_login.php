...
<head>
  ...
  <title>Kopipreneur || Log in</title>
...
<body onload="openEyes()">
  <div class="container" id="loginContainer" style="background-color: #192226ff;">
  <h1 class="text-center" style="color: white;"><b>KOPIPRENEUR</b></h1>
  <p class="text-center" style="color: white;">Silahkan login . .</p>
...
-->
    ...
    <div style="width: 100%">
      ...
      <div style="margin: 40px 40px;">
        ...
        <input style="border-color: #2a3b41ff" onfocus="openEyes();" onblur="movePupilsToCenter();" name="username" id="username" type="text" placeholder="Username">
      </div>
    </div>
    <div style="margin: 40px 40px;">
      <div style="text-align: center">
        <input style="border-color: #2a3b41ff" onfocus="closeEyes();" onblur="openEyes();" name="password" id="password" type="password" placeholder="Password">
      </div>
    </div>
    <div style="margin: 40px 40px;">
      <div style="text-align: center">
        <button type="submit" name="submit" style="background-color: #248cbcff; color:white; border-color: #2a3b41ff">Login</button>
      </div>
      </form>
    </div>
  </div>
