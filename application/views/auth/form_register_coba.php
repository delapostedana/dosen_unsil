...
<head>
  ...
  <title>Dosen Unpam | Registration</title>
...
<!-- <div class="register-box">
  <div class="register-logo">
    <a href="<?= base_url() ?>/assets/index2.html">Dosen<b>UNPAM</b></a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="<?= base_url() ?>/assets/index.html" method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <a href="<?= base_url('dashboard') ?>" type="submit" class="btn btn-primary btn-block btn-flat">Register</a>
        </div>
    ...
    <div class="row">
     <section>
        <div class="wizard">
            ...
            <form name="formPendaftaran" role="form" method="POST">
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                      <h3 class="bg-primary text-center h3">Data Akun</h3>
                        <div class="step1">
                          <div class="row">
                              <div class="col-md-6">
                                  <label for="nama_depan">Nama Depan</label>
                                  <input type="text" data-error="Nama depan harus diisi" class="form-control" id="nama_depan" name="nama_depan" placeholder="Nama depan" required>
                              </div>
                              <div class="col-md-6">
                                  <label for="nama_belakang">Nama Belakang</label>
                                  <input type="text" required="required" class="form-control" id="nama_belakang" name="nama_belakang" placeholder="Nama belakang" required>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="passconf" name="passconf" placeholder="Konfirmasi Password" required>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        ...
                        <div class="row">
                              <div class="col-md-6">
                                  <label for="nama_depan">Nama Depan</label>
                                  <input type="text" data-error="Nama depan harus diisi" class="form-control" id="nama_depan" name="nama_depan" placeholder="Nama depan">
                              </div>
                              <div class="col-md-6">
                                  <label for="nama_belakang">Nama Belakang</label>
...
<script type="text/javascript">
    ...
    $(".next-step").click(function (e) {
      // if (document.forms["formPendaftaran"]["nama_depan"].value == "") {
      //           alert("Nama Depan Tidak Boleh Kosong");
      //           document.forms["formPendaftaran"]["nama_depan"].focus();
      //           return false;
      //       }
      // else if (document.forms["formPendaftaran"]["email"].value == "") {
