        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div style="background-color: white;" id="canvas-holder">
            ...
            <h5 class="text-center">
              ...
              <span class="bg-danger" style="margin-right: 5px; padding: 5px; border-radius: 5px"> Reject : <?= $pengajuan_reject ?> </span>
            </h5>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $a['nama_user']; ?></td>
                        <td class="text-center">
                          <p class="bg-warning"><?= $a['status_pengajuan']; ?></p>
                        </td>
                      </tr>
                    <?php } ?>
                  </table>
